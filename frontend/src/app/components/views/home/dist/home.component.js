...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(productService, route, CarrinhoService) {
        var _this = this;
        ...
        this.funcao = function () {
            ...
            var get = function () {
                ...
                _this.productService.getProdutsCar(state.limite, state.offsete).subscribe(function (data) {
                    _this.cards = data['response'].produtos;
                });
                return get;
            };
            var html = {
